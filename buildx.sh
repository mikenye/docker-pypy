...
build_image 2>&1 | awk '{print "[i386] " $0}'
...
BUILD_CONTEXT="x86_64"
build_image 2>&1 | awk '{print "[amd64] " $0}'
...
build_image 2>&1 | awk '{print "[armv6] " $0}'
...
BUILD_CONTEXT="arm32v7"
build_image 2>&1 | awk '{print "[armv7] " $0}'
...
BUILD_CONTEXT="arm64"
build_image 2>&1 | awk '{print "[arm64] " $0}'
...
BUILD_ARCHLABEL=""
BUILD_CONTEXT="amd64"
build_image 2>&1 | awk '{print "[multiarch] " $0}'
